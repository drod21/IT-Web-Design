...
$query = "SELECT iname, AVG(objective), AVG(interest), AVG(overall) FROM questionnaire GROUP BY iname";
...
echo "<br />";
echo "The overall average score of the Course for ". $row['iname']. " is ".$row['AVG(overall)'];
echo "<br />"; 
}
}
?>
