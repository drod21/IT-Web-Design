...
$data_dir = "./data/";
#$data_dir = "/home/velma/faculty/pbao/public_html/cgi-bin/data/";
...
$show_link = "http://www.comp.polyu.edu.hk/~csbao/course/035/index.html";
...
# ------- Modify at 25/02/2000 -------
print "<br>";

if ($show_link =~ /http:\/\//) {
   print "<a href=\"$show_link\">";
}

@count_no=split(/ */,$print_count);
for ($i=0;$i<$pad_size;$i++)
{
   print "<img src=\"./digit/$count_no[$i].gif\">";
}
...
sub error {
   ...
   if ($error eq 'page_not_found') {
      ...
      print "[TextCounter Fatal Error: Could Not Write to File $data_dir$count_page]";
   }
